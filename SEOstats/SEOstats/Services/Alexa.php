...
class Alexa extends SEOstats
{
	 ...
	 */
	public function getMyGlobalRank($domain){
	...
	$tmp = !$nodes->item(0) ? parent::noDataDefaultValue() : self::retInt( strip_tags($nodes->item(0)->nodeValue) );
	//var_dump($tmp);die();
	//file_put_contents("/tmp/my2.log",$tmp);
        return $tmp;
    }
